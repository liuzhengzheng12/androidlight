package androidlight.vpn.config;
...
import androidlight.vpn.core.ChinaIpMaskManager;
...
public class ProxyConfig {
    ...
    private ArrayList<IPAddress> m_IpList;
    private ArrayList<IPAddress> m_DnsList;
    private ArrayList<IPAddress> m_RouteList;
    public ArrayList<Config> m_ProxyList;
    private HashMap<String, Boolean> m_DomainMap;
    ...
    public void addProxyToList(String proxyString) throws Exception {
        ...
        if (proxyString.startsWith("ss://")) {
            config = AndroidlightConfig.parse(proxyString);
        } else {
