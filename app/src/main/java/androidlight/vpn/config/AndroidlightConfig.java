...
public class AndroidlightConfig extends Config {
    public String EncryptMethod;
    public String Password;

    static AndroidlightConfig parse(String proxyInfo) throws Exception {
        AndroidlightConfig config = new AndroidlightConfig();
